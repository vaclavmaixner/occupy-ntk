...
def test_new_occupation():
    new_occ = new_occupation(id=1234,f6=11,f5=12,f4=13,f3=140,ts=datetime(2001, 1, 1))
...
def test_getters():
    new_occ = new_occupation(id=1234,f6=11,f5=36,f4=100,f3=140,ts=datetime(2001, 1, 1))
...
def test_getters_zero_vals():
    new_occ = new_occupation(id=1234,f6=0,f5=0,f4=0,f3=0,ts=datetime(2001, 1, 1))
...
def test_getters_overload():
    new_occ = new_occupation(id=1234,f6=110,f5=120,f4=130,f3=140,ts=datetime(2001, 1, 1))
